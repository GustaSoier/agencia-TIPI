...
<div class="container-inserir">
    <form action="index.php?p=blog&b=atualizar$id=<?php echo $blog -> idBlog ?>" method="POST" enctype="multipart/form-data">


            <label for="foto">Escolher Foto:</label>
            <div class="foto-preview">
                <img src="<?php echo '../img/' . $blog -> imgBlog ?>" alt="" id="imagemExibida">
            </div>
            ...
            <input type="text" id="tituloServico" name="tituloServico" value="<?php echo $blog -> tituloBlog ?>" required>
        
            <h3>Status Serviço:</h3>
            <input type="checkbox" id="status" name="statusServico" value="<?php echo $blog -> statusBlog ?>" required>
             <label for="status"></label>

            <label for="texto">Texto do Serviço:</label>
            <textarea id="texto" name="textoServico" required><?php echo $blog -> textoBlog ?></textarea>
        

            <label for="link">Link do Serviço:</label>
            <input type="text" id="link" name="linkServico" value="<?php echo $blog -> linkBlog ?>" required>
